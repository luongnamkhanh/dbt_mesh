"""
DAMA Reconciliation Scanner - DEV_STD vs DEV_KM

This DAG reconciles data between:
- Source: dev_std (Delta Lake - standardized tables)
- Target: dev_km (Oracle - KM DWH tables)

Table Mappings:
- arr_referrer_activity (dev_std) → FT_STD_ARR_REFERRER_ACTIVITY (dev_km)
- channel (dev_std) → FT_STD_CHANNEL (dev_km)
- branch (dev_std) → FT_STD_BRANCH (dev_km)
- arr_ownership_relative (dev_std) → FT_STD_ARR_OWNERSHIP_RELATIVE (dev_km)
- arr_officer_relative (dev_std) → FT_STD_ARR_OFFICER_RELATIVE (dev_km)

DAMA Dimensions Covered:
- Completeness: Row counts, NULL counts on primary keys
- Uniqueness: Primary key duplicate detection
- Consistency: MINUS comparison (dev_std EXCEPT dev_km)

Output: reconcile_dev_std_km_{YYYYMMDD_HHMMSS}.csv
"""
...
# Target table prefix for dev_km (Oracle)
# Source: arr_referrer_activity (lowercase) → Target: FT_STD_ARR_REFERRER_ACTIVITY (uppercase with prefix)
TARGET_TABLE_PREFIX = 'FT_STD_'
...
TABLE_WHERE_CONDITIONS = {
    ...
    'kyc_request_comm': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'payment_instruction': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'arr_campaign_activity': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'arr_ownership_relative': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'arr_int_rate_activity': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'arr_referrer_activity': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'deposit_arr_hold_item': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'fx_transaction': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'debt_trading_position': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'debt_transaction': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'payment_transaction': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},
    'tf_instruction': {'source_col': 'DS_DT', 'target_col': 'SYM_RUN_DATE', 'type': 'Fact Append'},

    # Fact Snapshot tables: DS_SNAPSHOT_DT for both
    'arr_activity_schedule_item': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'Fact Snapshot'},
    'arr_balance': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'Fact Snapshot'},
    'collateral_arr_sec_smy': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'Fact Snapshot'},
    'exchange_rate_hist': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'Fact Snapshot'},
    ...
    # SCD1 tables: Full table for source, SYM_RUN_DATE for target
    'calendar_date': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD1'},
    'currency': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD1'},

    # SCD2 tables: Full table for source, SYM_RUN_DATE for target
    'arr_joint_owner_relative': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'arr_officer_relative': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'cdt_lmt_arrgmnt_cstmr_rltn': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'credit_limit_arr_relative': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'cstmr_asst_hldg_rltn': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'customer_rltsh': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'geog_area_hierarchy': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'prop_type_cfg_rel': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},
    'ft_t24_deposit_ca': {'source_col': None, 'target_col': 'SYM_RUN_DATE', 'type': 'SCD2'},

    # SCD4A tables: DS_SNAPSHOT_DT for both
    'arr_activity_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'arr_interest_rate_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'arrangement_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'branch_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'channel_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'class_value_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'collateral_allocation_info_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'collateral_arrangement_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'credit_facility_arr_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'credit_limit_arr_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'customer_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'debt_instrument_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'department_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'deposit_arrangement_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'fatca_customer_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'fatca_doc_item_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'fatca_org_owner_profile_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'financial_property_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'geog_area_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'individual_empe_status_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'individual_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'insur_policy_doc_item_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'involved_party_alt_id_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'involved_party_cr_profile_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'involved_party_email_addr_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'involved_party_postal_addr_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'kyc_request_doc_item_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'lc_arrangement_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'lending_restructure_info_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'loan_arr_participant_info_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'loan_arrangement_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'officer_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'org_profile_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'organization_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'property_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'rating_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'real_property_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'repay_schedule_activity_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'user_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    'vehicle_property_hstr': {'source_col': 'DS_SNAPSHOT_DT', 'target_col': 'DS_SNAPSHOT_DT', 'type': 'SCD4A'},
    ...
    # Curated Fact Append tables: DS_DT for source, SYM_RUN_DATE for target
...
def build_dataset_where_clauses(partition_value: str) -> tuple:
    """Build WHERE clauses for Dataset tables (Curated layer)

    Both source and target use ds_sym_run_dt/DS_SYM_RUN_DT
    ...
    """
    # Source (Spark/Delta): lowercase with backticks
    source_where = f"`ds_sym_run_dt` = '{partition_value}'" if partition_value else ""
    # Target (Oracle via Spark JDBC): uppercase with date_trunc
    target_where = f"date_trunc('day', DS_SYM_RUN_DT) = '{partition_value}'" if partition_value else ""
    return source_where, target_where
...
def get_where_clauses_for_table(table_name: str, partition_value: str) -> tuple:
    ...
    if table_type == 'Fact Append':
        ...
        return build_dataset_where_clauses(partition_value)
    else:
...
class ReconciliationScannerDevStdKm:
    """
    DAMA-aligned reconciliation scanner for dev_std vs dev_km.

    Compares Delta Lake tables (dev_std) against Oracle tables (dev_km).
    """

    def __init__(
        self,
        source_catalog_name: str = 'dev_std',
        ...
        # Source: dev_std (Delta Lake - 2-level namespace: catalog.table)
        ...
        self.output_filename = f'reconcile_dev_std_km_{self.run_timestamp}.csv'
    ...
    def get_tables_from_source_catalog(self, cursor) -> List[str]:
        """Discover all tables from source catalog (dev_std).
    ...
    def get_tables_to_reconcile(self, cursor) -> List[str]:
        ...
        Returns source table names (dev_std format: lowercase).
        """
    ...
    def map_source_to_target_table(self, source_table_name: str) -> str:
        """
        Map source table name (dev_std) to target table name (dev_km).

        Source naming: arr_referrer_activity (lowercase)
        Target naming: FT_STD_ARR_REFERRER_ACTIVITY (uppercase with prefix)
        """
        # Convert to uppercase and add FT_STD_ prefix
    ...
    def detect_pk_columns(self, cursor, full_table_name: str) -> List[str]:
        ...
        STD tables typically have columns ending with '_id' or '_cd' as identifiers.
        ...
        try:
            ...
            # Common PK patterns for STD tables (prioritized)
            pk_candidates = []
    ...
    def get_source_row_count(self, cursor, source_table: str, source_where: str = "") -> Dict:
        """Get row count from source (dev_std) table
    ...
    def get_minus_metrics(self, cursor, source_table: str, target_table: str,
        ...
        """
        MINUS metrics: Source (dev_std) EXCEPT Target (dev_km)
        ...
        try:
            ...
            # Get columns from target table (uppercase)
            # get_table_columns lowercases before comparison, so pass lowercase set
    ...
    def run(self) -> Dict:
        ...
        logger.info("=" * 80)
        logger.info("Starting dev_std vs dev_km reconciliation scan")
        logger.info("=" * 80)
...
def scan_dev_std_km(**context):
    ...
    scanner = ReconciliationScannerDevStdKm(
...
dag = DAG(
    dag_id='reconciliation_dev_std_km',
    default_args=default_args,
    description='DAMA Reconciliation Scanner - dev_std vs dev_km',
    schedule=None,
    start_date=datetime(2024, 10, 23),
    catchup=False,
    max_active_runs=1,
    tags=['type::reconciliation', 'layer::std', 'tool::spark', 'catalog::dev_std', 'catalog::dev_km', 'dama'],
    params={
        'source_catalog_name': Param(
            default='dev_std',
            type='string',
            description='Source catalog name (Delta Lake, default: dev_std)'
        ),
        ...
        'table_patterns': Param(
            default=[],
            type='array',
            description='Array of table names or regex patterns to reconcile (source/dev_std names). Empty = scan all tables from source catalog.'
        ),
...
scan_task = PythonOperator(
    task_id='scan_dev_std_km',
    python_callable=scan_dev_std_km,
    dag=dag,
)
